const music = new Audio('Music/39.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhari/1.jpg",          
    },
    {
        id: '2',
        songName: `7 Rings<br>
                        <div class="subtitle">Ariana Grande</div>`,
        poster: "Picture_CSN/anhari/2.jpg",          
    },
    {
        id: '3',
        songName: `One Last Time<br>
                            <div class="subtitle">Ariana Grande</div>`,
        poster: "Picture_CSN/anhari/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/ari/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhari/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/ari/${index}.mp3`;
