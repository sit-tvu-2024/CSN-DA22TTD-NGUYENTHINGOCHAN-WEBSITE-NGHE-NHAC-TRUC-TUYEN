const music = new Audio('Music/19.mp3');
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/jk/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhjk/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/jk/${index}.mp3`;
