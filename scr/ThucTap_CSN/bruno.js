...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhbruno/1.jpg",          
    },
    {
        id: '2',
        songName: `Talking to the moon<br>
        <div class="subtitle">Bruno Mars</div>`,
        poster: "Picture_CSN/anhbruno/2.jpg",          
    },
    {
        id: '3',
        songName: `That’s What I Like <br>
        <div class="subtitle">Bruno Mars </div>`,
        poster: "Picture_CSN/anhbruno/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/bruno/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhbruno/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/bruno/${index}.mp3`;
