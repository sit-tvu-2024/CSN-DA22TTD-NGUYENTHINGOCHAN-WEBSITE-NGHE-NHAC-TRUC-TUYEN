const music = new Audio('Music/27.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhbts/1.jpg",          
    },
    {
        id: '2',
        songName: `Idol<br>
                        <div class="subtitle">BTS</div>`,
        poster: "Picture_CSN/anhbts/2.jpg",          
    },
    {
        id: '3',
        songName: `Love Maze<br>
                            <div class="subtitle">BTS</div>`,
        poster: "Picture_CSN/anhbts/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/bts/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhbts/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/bts/${index}.mp3`;
