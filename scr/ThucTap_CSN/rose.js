const music = new Audio('Music/12.mp3');
...
const songs = [
    {
        id: '1',
        songName: `On The Ground<br>
                        <div class="subtitle">Rosé</div>`,
        poster: "Picture_CSN/anhrose/1.jpg",
    ...
    
    {
        ...
        songName: `APT<br>
                        <div class="subtitle">Rosé</div`,
        poster: "Picture_CSN/anhrose/2.jpg",
    },
    {
        id: '3',
        songName: `Gone<br>
                        <div class="subtitle">Rosé</div>`,
        poster: "Picture_CSN/anhrose/3.jpg",
    },
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/rose/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhrose/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/rose/${index}.mp3`;
