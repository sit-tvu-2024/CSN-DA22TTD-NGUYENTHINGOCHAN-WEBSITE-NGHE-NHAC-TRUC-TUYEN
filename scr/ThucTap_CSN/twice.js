const music = new Audio('Music/33.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhtwice/1.jpg",          
    },
    {
        id: '2',
        songName: `Fancy<br>
                        <div class="subtitle"> TWICE</div>`,
        poster: "Picture_CSN/anhtwice/2.jpg",          
    },
    {
        id: '3',
        songName: `I can't stop me<br>
                            <div class="subtitle"> TWICE</div>`,
        poster: "Picture_CSN/anhtwice/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/twice/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhtwice/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/twice/${index}.mp3`;
