const music = new Audio('Music/30.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhjen/1.jpg",          
    },
    {
        id: '2',
        songName: `Mantra<br>
                        <div class="subtitle">JENNIE</div>`,
        poster: "Picture_CSN/anhjen/2.jpg",          
    },
    {
        id: '3',
        songName: `One of the girls<br>
                            <div class="subtitle">JENNIE</div>`,
        poster: "Picture_CSN/anhjen/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/jen/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhjen/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/jen/${index}.mp3`;
