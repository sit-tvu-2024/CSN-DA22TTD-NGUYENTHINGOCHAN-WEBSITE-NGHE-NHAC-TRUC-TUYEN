const music = new Audio('Music/24.mp3');
...
const songs = [
    {
        id: '1',
        songName: `Cruel Summmer<br>
                    <div class="subtitle">Taylor Swift</div>`,
        poster: "Picture_CSN/anhtaylor/1.jpg",          
    },
    {
        id: '2',
        songName: `Look what to made me do<br>
                        <div class="subtitle">Taylor Swift</div>`,
        poster: "Picture_CSN/anhtaylor/2.jpg",          
    },
    {
        id: '3',
        songName: `Love Story<br>
                            <div class="subtitle">Taylor Swift</div>`,
        poster: "Picture_CSN/anhtaylor/3.jpg",          
    }
]

/*Array.from(document.getElementsByClassName('song_item')).forEach((element,i) => {
    element.getElementsByTagName('Picture_CSN')[0].src = songs[i].poster;
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/taylor/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhtaylor/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/taylor/${index}.mp3`;
