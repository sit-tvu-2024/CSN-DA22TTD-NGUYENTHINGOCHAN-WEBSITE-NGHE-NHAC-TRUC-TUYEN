const music = new Audio('Music/36.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhbbm/1.jpg",          
    },
    {
        id: '2',
        songName: `Batter up<br>
                        <div class="subtitle"> BABYMONSTER</div>`,
        poster: "Picture_CSN/anhbbm/2.jpg",          
    },
    {
        id: '3',
        songName: `Like That<br>
                            <div class="subtitle"> BABYMONSTER</div>`,
        poster: "Picture_CSN/anhbbm/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/bbm/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhbbm/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/bbm/${index}.mp3`;
