const music = new Audio('Music/42.mp3');
...
const songs = [
    {
        ...
        poster: "Picture_CSN/anhdoja/1.jpg",          
    },
    {
        id: '2',
        songName: `Agora Hills<br>
                        <div class="subtitle">  Doja Cat</div>`,
        poster: "Picture_CSN/anhdoja/2.jpg",          
    },
    {
        id: '3',
        songName: `Woman<br>
                            <div class="subtitle"> Doja Cat</div>`,
        poster: "Picture_CSN/anhdoja/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/doja/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhdoja/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/doja/${index}.mp3`;
