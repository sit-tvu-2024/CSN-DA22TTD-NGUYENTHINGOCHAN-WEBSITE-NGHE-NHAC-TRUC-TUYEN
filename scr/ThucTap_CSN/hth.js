const music = new Audio('Music/21.mp3');
...
const songs = [
    {
        id: '1',
        songName: `Không phải gu<br>
                    <div class="subtitle">HIEUTHUHAI</div>`,
        poster: "Picture_CSN/anhhth/1.jpg",          
    },
    {
        id: '2',
        songName: `Ngủ một mình<br>
                        <div class="subtitle">HIEUTHUHAI</div>`,
        poster: "Picture_CSN/anhhth/2.jpg",          
    },
    {
        id: '3',
        songName: `Exit Sign<br>
                            <div class="subtitle">HIEUTHUHAI</div>`,
        poster: "Picture_CSN/anhhth/3.jpg",          
    }
]
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((e)=>{
    e.addEventListener('click',(el) =>{
        index = el.target.id;
        music.src = `Music/hth/${index}.mp3`;
        poster_masterplay.src =`Picture_CSN/anhhth/${index}.jpg`;
        music.play();
        master_play.classList.remove('bi-play-fill');
        master_play.classList.add('bi-pause-fill');
        download_music.href = `Music/hth/${index}.mp3`;
